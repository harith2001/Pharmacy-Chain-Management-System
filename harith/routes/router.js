...
router.get("/stock/getdata",async(req,res)=>{
...
router.get("/stock/getstock/:id",async(req,res)=>{
    try {
...
router.patch("/stock/updatestock/:id",async(req,res)=>{
    try {
        const{id}=req.params;
...
//detele stock
router.delete("/stock/deletestock/:id",async(req,res)=>{
    try {
        const{id}=req.params;
...
//Search Stock
router.get("/stock/searchdata/:Medicine_ID",async(req,res)=>{
    try {
        console.log(req.params);
